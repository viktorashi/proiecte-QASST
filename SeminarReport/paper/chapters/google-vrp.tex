...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/bio-before.png}
    \includegraphics[width=0.3\textwidth]{figures/url.png}
    \includegraphics[width=0.3\textwidth]{figures/bio-now.png}
    \caption{Showcasing the attack}
    \label{fig:attack-screenshots}
\end{figure}
