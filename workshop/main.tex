...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\columnwidth]{my-pics/hwfly-pe-birou.jpg}
  \caption{The HW Picofly Modchip I bought, on my desk}  
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\columnwidth]{my-pics/hwfly-pe-aliexpress.jpg}
  \caption{Realllly good price tbh}  
\end{figure}
...
Then, if you're not careful of what you do after you got ahold of running unsigned code, you might have to face the consequences:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\columnwidth]{my-pics/sorryyoucant.jpg}
  \caption{OOps 1}  
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\columnwidth]{my-pics/step1.jpg}
  \caption{OOps 2}  
\end{figure}
