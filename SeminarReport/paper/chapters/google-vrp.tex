...
This exploit, \cite{googlesource-oauthtoken-leak, oauthtoken-leak-bughunters} has to do with the way Android source editor was parsing their \cite{android-source-editor}
