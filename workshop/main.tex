...
The modern "modchip" approach (HWFLY, Picofly) employs Voltage Fault Injection (VFI) to bypass the BootROM's signature verification. This technique, often referred to as "glitching," relies on inducing a transient fault in the CPU's logic circuitry \cite{limitedresults2019vfi}.
