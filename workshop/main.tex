...
\begin{figure}[htbp]
  ...
  \framebox{\parbox{0.9\columnwidth}{\centering
    \vspace{2cm}
    \textbf{Figure 2: Architecture Layers} \\
    \small\textit{Fusée (Loader) $\rightarrow$ Exosphère (Secure Monitor) $\rightarrow$ Mesosphere (Kernel) $\rightarrow$ Stratosphère (Userland).}
    \vspace{2cm}
  }}
  \caption{Atmosphere Layering \cite{switchbrew}}
  \label{fig:atmo}
\end{figure}
