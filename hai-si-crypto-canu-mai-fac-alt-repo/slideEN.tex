...
\begin{frame}{Step 1: Arithmetization (Trace to Polynomial)}
    \small
    How do we turn a computer program into a math problem?
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            ...
            \textit{A table of the computation state at every step.}
            \vspace{0.2cm}
            \begin{table}
                \centering
                \begin{tabular}{|c|c|}
...
\begin{frame}{Step 2: The "Honesty" Check}
    \small
    We define a rule (Constraint) that must equal \textbf{Zero} if the computation is valid.
