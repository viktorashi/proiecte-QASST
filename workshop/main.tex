...
\author{Five nights at freddy's 5 \\ \textit{Software Engineering Research}}
\date{\today}
...
\begin{figure}[htbp]
  ...
  \framebox{\parbox{0.9\columnwidth}{\centering
    \vspace{2cm}
    \textbf{Figure 1: VFI Timing Diagram} \\
    \small\textit{Visualizing the voltage drop (glitch) alignment relative to the CPU Clock Cycle.}
    \vspace{2cm}
  }}
  \caption{Voltage Fault Injection Timing}
  \label{fig:vfi}
\end{figure}
