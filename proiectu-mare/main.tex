...
5 & Web Server Transmits Cleartext Credentials CWE-319 & \textbf{file:} \texttt{app.py} \newline \textbf{function:} \texttt{login} \newline \textbf{token:} JWT session token (\texttt{'token'} cookie) \\ \hline
6 & Clickjacking CVE-2025-64387 & \textbf{file:} \texttt{app.py} & \textbf{data:} User browser session, frontend UI \\ \hline
\end{tabular}
\end{table}
