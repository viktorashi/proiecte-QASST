The very idea of the Google bug bounty / Vulnerability Reward program (VRP) stemmed from the   
The Google Vulnerability Reward Program (VRP) is one of the many initiatives designed to incentivise ethical hackers to find and disclose security vulnerabilities in Google's products and services. The folks over at google established a formal set of criteria by which basement-dwellers have to abide
