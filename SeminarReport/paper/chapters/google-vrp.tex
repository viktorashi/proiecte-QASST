...
All of the following rules and regulations can be found here: \cite{google_bughunters_invalid_reports}, \cite{google_bughunters_report} , \cite{google_bughunters_rules}
\begin{enumerate}[label=\textbf{\arabic*}., align=left, leftmargin=0pt, itemsep=5pt]
    ...
    \begin{itemize}
        ...
        \item Actively search for fixable stuff.
    \end{itemize}
    \item \textbf{Report Submission ($\mathcal{R}$):}
    \begin{itemize}
        \item Submit a detailed report $\mathcal{R}$ containing the steps to reproduce the vulnerability (V), some PoC, and analysis of the securty impact of your findings.
    \end{itemize}
    \item \textbf{Coordinated Disclosure:}
    \begin{itemize}
        \item None of it can come out before Google has already patched the vulnerability.
    \end{itemize}
